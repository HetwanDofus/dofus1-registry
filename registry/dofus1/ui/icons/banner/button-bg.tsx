...
export function ButtonBgUp({ className }: { className?: string }) {
  ...
  return (
    <svg className={className} viewBox="0 0 26 26" fill="none">
      ...
      <defs>
        <radialGradient id={id} gradientTransform="matrix(0.012, 0, 0, 0.012, 9, 7.9)" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="819.2">
...
export function ButtonBgDown({ className }: { className?: string }) {
  ...
  return (
    <svg className={className} viewBox="0 0 26 26" fill="none">
      ...
      <circle cx="13" cy="13" r="12" fill={`url(#${id})`} />
      <defs>
        <radialGradient id={id} gradientTransform="matrix(-0.012, 0, 0, -0.012, 17, 18.1)" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="819.2">
          <stop offset="0.012" stopColor="#ff8737" />
          <stop offset="1" stopColor="#ff6600" />
        </radialGradient>
      </defs>
